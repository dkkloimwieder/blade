//=============================================================================
// Render Shader - Draws ALL instances directly (no culling indirection)
//=============================================================================
// Baseline version for comparison with frustum-cull example.
// instance_idx directly indexes objects[] - no visible_indices lookup.
...
fn vs_main(
    ...
    // Direct lookup - no indirection through visible_indices
